"""Streaming ABI contract tests.

Verifies that delta_core framing yields delta frames followed by a terminal result.
"""
...
def test_non_streaming_still_works(client):
    ...
    result = client.command({"cmd": "hello", "protocol_version": 1})
