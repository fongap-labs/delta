...
def request_directory_tool() -> Callable[..., dict[str, Any]]:
    def request_directory(reason: str, path: str = "", is_writable: bool = False) -> dict:
        ...
        `is_writable` access. The user picks/approves the folder; the result says whether it was
