...
export async function chooseFolder(): Promise<string | null> {
  ...
  const { pickWorkspaceFolder } = await import("./api");
  return pickWorkspaceFolder();
}

/** Open-at-login (macOS LaunchAgent). */
export const getAutostart = () => invoke<boolean>("get_autostart");
export const setAutostart = (isEnabled: boolean) => invoke<boolean>("set_autostart", { isEnabled });
...
export const setKeepAwake = (isEnabled: boolean) => invoke<boolean>("set_keep_awake", { isEnabled });
...
export const setNativeTheme = (isDark: boolean) => invoke<boolean>("set_native_theme", { isDark });
...
export const cancelDictationDownload = () => invokeStrict<void>("cancel_dictation_download");
export const verifyDictationModel = () => invokeStrict<DictationStatus>("verify_dictation_model");
export const markDictationPassed = () => invokeStrict<DictationStatus>("mark_dictation_passed");
export const deleteDictationModel = () => invokeStrict<DictationStatus>("delete_dictation_model");

export async function listenDictationProgress(
