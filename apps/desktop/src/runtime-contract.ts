...
const optionalBoolean = (value: unknown, isDefault: boolean): boolean =>
  typeof value === "boolean" ? value : isDefault;
    ...
    ...(usage
      ? {
          usage: {
            ...
            input: requireNonnegativeNumber(usage.input, "usage.input"),
            output: requireNonnegativeNumber(usage.output, "usage.output"),
            cache_read: requireNonnegativeNumber(usage.cache_read, "usage.cache_read"),
            cache_write: requireNonnegativeNumber(usage.cache_write, "usage.cache_write"),
          },
        }
      : {}),
  };
...
export function parseArtifactDto(value: unknown): ArtifactDto {
  ...
  return {
    ...
    size: requireNonnegativeNumber(input.size, "size"),
